...
namespace Project.DesktopClient.ViewModels.User.Dialogs
{
    public class UserEditDialogViewModel : BindableBase, IDialogAware
    {
        ...
        private string _title = "Editar Usuário";
        ...
        public UserEditDialogViewModel(ApiClient apiClient, IBusyService busyService)
        {
            _apiClient = apiClient;
            _busyService = busyService;

            CancelCommand = new DelegateCommand(Cancel);
            EditUserCommand = new DelegateCommand(async () => await EditUserAsync());
        }
        ...
        private async Task EditUserAsync()
        {
            ...
            await _apiClient.PatchUserAsync(UserId, updatedUser);
        ...
        // Passa o Id do usuário selecionado como parâmetro
